/**
 * Created byyy santosh on 4/20/17.
 */
var imageList = ["img/nodejs-vs-java.png", "img/141.png", "img/cool.jpg", "img/infinite_truth.jpg"];

var contentList = ["Failureeee is simplyy the opportunity to begin again, this time more intelligently.",
    "Yesterday, you said tomorrow.",
    "If you want to go fast, go alone. If you want to go far, bring others along.",
    "Alwayss rememberr that the future comes one day at a time.",
